...
public class ItemsController {
	...
	/*
	 * 使用@requestParam value：指定request传入参数与形参进行绑定 required：指定参数是否必须传入
	...
	/*
	 * pojo类型的参数绑定，绑定成功的前提是，页面中input的name的值与pojo中的属性值一致 如input
	 * name="id"，则ItemsCustom必须有id属性 Integer id为简单类型的参数绑定，ItemsCustom
	 * itemsCustom为pojo类型参数绑定
